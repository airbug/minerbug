...
//@Export('minerbugworker.MinerbugWorkerConfiguration')
//@Autoload
...
require('bugpack').context("*", function(bugpack) {
    ...
    var MinerbugWorkerConfiguration = Class.extend(Obj, {
        ...
        _name: "minerbugworker.MinerbugWorkerConfiguration",
    ...
    Class.implement(MinerbugWorkerConfiguration, IInitializingModule);
