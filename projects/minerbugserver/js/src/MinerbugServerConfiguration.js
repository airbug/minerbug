...
//@Export('minerbugserver.MinerbugServerConfiguration')
//@Autoload
...
require('bugpack').context("*", function(bugpack) {
    ...
    var MinerbugServerConfiguration = Class.extend(Obj, {
        ...
        _name: "minerbugserver.MinerbugServerConfiguration",
    ...
    Class.implement(MinerbugServerConfiguration, IInitializingModule);
